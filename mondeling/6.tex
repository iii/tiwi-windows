...
\subsection{Wordt server al dan niet opgenomen in een domein?}
...
\subsection{Vervult de in een domein opgenomen server al dan niet de functie van
domeincontroller?}
...
\subsection{Indien gekozen wordt voor domeincontroller, moet ook de functie van
...
\subsection{Welke domain controllers worden als RODC ingesteld?}
...
\subsection{Welke domeincontrollers vervullen de operations master rollen?}
